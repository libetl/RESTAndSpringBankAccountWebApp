...
public class IllegalAccountHistoryOperation extends BankAccountException {
    ...
    public String toString () {
        return "Illegal operation on account : " + this.accountHistoryOperation.getDate () + " " + this.accountHistoryOperation.getIssuer () + " " + this.accountHistoryOperation.getType ().name () + " " + this.accountHistoryOperation.getAmount ();
    }
