...
public class BasicHashSetAccountRepository implements AccountRepository {
     ...
     * (non-Javadoc)
     *
     * @see org.toilelibre.libe.bank.impl.account.AccountRepository#addOrUpdate(org.toilelibre.libe.bank.model.account.Account)
     */
    @Override
     ...
     *
     * @see
     * org.toilelibre.libe.bank.impl.account.AccountRepository#get(java.lang.String)
     */
    @Override
