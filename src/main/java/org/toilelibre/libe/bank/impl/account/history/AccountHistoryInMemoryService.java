...
public class AccountHistoryInMemoryService implements AccountHistoryService {
    ...
    public AccountHistoryOperation addToHistory (final String iban, final AccountHistoryOperation accountHistoryOperation, final AccountHistoryOperationRule rule) throws BankAccountException {
