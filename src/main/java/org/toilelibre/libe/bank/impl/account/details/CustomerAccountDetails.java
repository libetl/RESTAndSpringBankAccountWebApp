...
public class CustomerAccountDetails implements AccountDetails {
    ...
    private CustomerAccountDetails (final String swiftCode1, final AccountDetailsContact contact1, final String address1, final String zipCode1, final String city1,
            final String state1, final String country1) {
    ...
    public static class Builder implements AccountDetails.Builder {
         ...
         *
         * @see
         * org.toilelibre.libe.bank.impl.account.details.Builder#withSwiftCode(
         * java .lang.String)
         */
        @Override
         ...
         *
         * @see
         * org.toilelibre.libe.bank.impl.account.details.Builder#withContact(org
         * .toilelibre.libe.bank.model.account.details.AccountDetailsContact)
         */
        @Override
         ...
         *
         * @see
         * org.toilelibre.libe.bank.impl.account.details.Builder#withAddress(
         * java.lang .String)
         */
        @Override
         ...
         *
         * @see
         * org.toilelibre.libe.bank.impl.account.details.Builder#withZipCode(
         * java.lang .String)
         */
        @Override
         ...
         *
         * @see
         * org.toilelibre.libe.bank.impl.account.details.Builder#withCity(java.
         * lang .String)
         */
        @Override
         ...
         *
         * @see
         * org.toilelibre.libe.bank.impl.account.details.Builder#withState(java.
         * lang .String)
         */
        @Override
         ...
         *
         * @see
         * org.toilelibre.libe.bank.impl.account.details.Builder#withCountry(
         * java.lang .String)
         */
        @Override
        ...
        @Override
        public Builder initFromMap (Map<String, Object> inputAsMap) throws IllegalDetailsException {
            this.withSwiftCode (this.safeAsString (inputAsMap.get ("swiftCode"))).withCountry (this.safeAsString (inputAsMap.get ("country")))
                    .withAddress (this.safeAsString (inputAsMap.get ("address"))).withZipCode (this.safeAsString (inputAsMap.get ("zipCode")))
            ...
            if (inputAsMap.get ("isCompany") != null && new Boolean (inputAsMap.get ("isCompany").toString ())) {
                this.withContact (
                        new CompanyAccountDetailsContact (this.safeAsString (inputAsMap.get ("corporateName")), this.statusSafeValueOf (inputAsMap.get ("corporateName"))));
            } else {
                this.withContact (new PersonAccountDetailsContact (this.titleSafeValueOf (inputAsMap.get ("title")), this.safeAsString (inputAsMap.get ("firstName")),
                        this.safeAsString (inputAsMap.get ("lastName"))));
            }
            return this;
        }
         ...
         * (non-Javadoc)
         *
         * @see org.toilelibre.libe.bank.impl.account.details.Builder#build(org.
         * toilelibre.libe.bank .model.account.details.AccountDetailsRule)
         */
        @Override
        ...
        public CustomerAccountDetails buildWithUnknownValues () {
            return new CustomerAccountDetails.Builder ().withContact (new PersonAccountDetailsContact (Title.UN, "UNKNOWN", "UNKNOWN")).withSwiftCode ("UNKNOWN")
                    .withAddress ("UNKNOWN").withCity ("UNKNOWN").withZipCode ("UNKNOWN").withState ("UNKNOWN").withCountry ("UN").securedBuildMethod ();
        }
