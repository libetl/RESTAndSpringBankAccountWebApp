...
public class AccountOperationResource {
    ...
    public Response<AccountHistoryOperation> deposit (@PathVariable final String iban, @RequestBody final JsonNode input) throws BankAccountException {
        ...
        return new Response<AccountHistoryOperation> (this.linkHelper.get (), this.accountOperationService.deposit (iban, amount, this.accountBalanceRule, this.accountHistoryOperationRule));
    }
    ...
    public Response<AccountHistoryOperation> withdraw (@PathVariable final String iban, @RequestBody final JsonNode input) throws BankAccountException {
        ...
        final double amount = input.get ("amount").asDouble ();
        return new Response<AccountHistoryOperation> (this.linkHelper.get (), this.accountOperationService.withdraw (iban, amount, this.accountBalanceRule, this.accountHistoryOperationRule));
    }
    ...
    public Response<AccountHistoryOperation> transfer (@PathVariable final String iban, @RequestBody final JsonNode input) throws BankAccountException {
        ...
        return new Response<AccountHistoryOperation> (this.linkHelper.get (), this.accountOperationService.transfer (iban, amount, recipient, this.accountBalanceRule, this.accountHistoryOperationRule));
    }
}
