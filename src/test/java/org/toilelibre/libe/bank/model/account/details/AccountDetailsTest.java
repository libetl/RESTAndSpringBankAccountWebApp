...
public class AccountDetailsTest {
    ...
    public void builderWithIncorrectSwiftCodeShouldThrowIllegalIbanException () throws IllegalSwiftCodeException {
        new CustomerAccountDetails.Builder ().withSwiftCode ("test").withContact (new PersonAccountDetailsContact (Title.MR, "John", "Doe")).withAddress ("112 downing street").withCity ("London").withZipCode ("EC1A 1BB").withState ("England").withCountry ("UK").build (this.accountDetailsRule);
    }

    @Test
    public void builderWithCorrectSwiftCodeShouldWork () throws IllegalSwiftCodeException {
        new CustomerAccountDetails.Builder ().withSwiftCode ("EBAPFRPPPSA").withContact (new PersonAccountDetailsContact (Title.MR, "John", "Doe")).withAddress ("112 downing street").withCity ("London").withZipCode ("EC1A 1BB").withState ("England").withCountry ("UK").build (this.accountDetailsRule);
    }
